...
def run_test_make_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '69-70-71-72-'
    actual = make_simple_string(69, 72)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '69-70-71-72'
    actual = make_less_simple_string(69, 72)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    for k in range((n - m) + 1):
        if (m + k) < n:
            less_simple = less_simple + str(m + k) + '-'
        else:
            less_simple = less_simple + str(m + k)
    return less_simple
...
def rectangles_from_circles(circles):
    ...
    for k in range(length):
        ...
        rectangles = rectangles + [rg.Rectangle(rg.Point(center.x - circles[k].radius, center.y - circles[k].radius),
                                 rg.Point(center.x + circles[k].radius, center.y + circles[k].radius))]
    return rectangles
